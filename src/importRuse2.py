...
#                 num=int(nums[i][pos1+1:pos2])
            ...
            software = temp[:pos - 1]
            strpos1 = temp[pos-1:]
            version=re.match(r'([0-9]+.)+[0-9]+',strpos1).group(0)
...
#             version = temp[pos - 1:temp.find(strpos3) - 1]
            ...
            openfilename = cve + '_' + software + version.replace('_','.')+ '_' + func
            if num>0:
...
#     filename = 'E:\workspace\pythonTest2\src\excel\Ffmpeg-reuse.xlsx'
    filename = 'E:\workspace\pythonTest2\src\excel\wireshark-reuse.xlsx'
